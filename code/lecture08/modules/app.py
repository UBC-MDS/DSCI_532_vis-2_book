...
def comparison_ui():
    return ui.card(
        ...
        ui.value_box(
            title="Average Bill Length (mm)", value=ui.output_ui("avg_bill_length_mm")
        ),
        ui.value_box(
            title="Average Bill Depth (mm)", value=ui.output_ui("avg_bill_depth_mm")
        ),
        ui.value_box(
...
def server(input, output, session):
    ...
    def comparisons():
        ...
        return ui.layout_columns(*comparison_uis, col_widths=3)
