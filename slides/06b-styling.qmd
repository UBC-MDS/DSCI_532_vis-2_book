...
[`ui.value_box()`](https://shiny.posit.co/py/api/core/ui.value_box.html) highlights a single KPI.
...
## Putting it together {.scrollable}
...
::: {style="display:flex; gap:1.2em; font-size:0.75em; color:#555; margin-top:0.3em;"}
[<span style="display:inline-block;width:2em;border-top:2px solid #999;vertical-align:middle;margin-right:0.3em"></span> reactive dep]{style="display:flex;align-items:center"}
[<span style="display:inline-block;width:2em;border-top:4px solid #999;vertical-align:middle;margin-right:0.3em"></span> side-effect push]{style="display:flex;align-items:center"}
[<span style="display:inline-block;width:2em;border-top:2px dashed #4CAF50;vertical-align:middle;margin-right:0.3em"></span> user action]{style="display:flex;align-items:center"}
:::
...
@reactive.calc
def filtered():
    _ = input.reset_btn()  # click invalidates filtered()
    df = cars.copy()
    if input.origin() != "All":
...
## Reset table selections {.scrollable}
